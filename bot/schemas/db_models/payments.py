...
from schemas.enum_models import PaymentStatus, PaymentOperator
...
class Payment(Base):
    ...
    operator: Mapped[PaymentOperator] = mapped_column(
        SQLAlchemyEnum(PaymentOperator), nullable=False
    )
